...
algorithms = {"DT": DecisionTreeClassifier(random_state = 42), "KNN": KNeighborsClassifier(), "RF": RandomForestClassifier(random_state = 42), "SVM_RBF": SVC(kernel = "rbf", random_state = 42), "SVM_LIN": SVC(kernel = 'linear', random_state = 42), "LogisticRegression": LogisticRegression(random_state = 42), "XGBoost": XGBClassifier(random_state = 42)}
...
algorithms_search_space = {"SVM_RBF": [Real(2e-10, 2e10, 'log-uniform', name = 'C'), Real(2e-10, 2e10, 'log-uniform', name = 'gamma')], 
                           ...
                           "XGBoost": [Real(2e-10, 2e10, 'log-uniform', name = 'alpha'), Integer(1, 15, name = 'max_depth'), Integer(1, 5000, name = 'nrounds')],
...
def set_params_algorithm(pipeline, params_result, algorithm):
    ...
    if algorithm == "SVM_RBF" or algorithm == "SVM_LIN":
        ...
        pipeline.named_steps['model'].set_params(alpha = params_result[0], max_depth = params_result[1], nrounds = params_result[2])
            ...
            for approach in approach_missing_values: 
                ...
                for seed in seeds:
                    ...
                    if tuning:
                        ...
                        optimize_result = tuning_process(pipeline, search_space, X, y, cv_stratified, seed)
                    ...
                    for counter, idx in enumerate(cv_stratified.split(X, y)):
                        ...
                        write_csv_features_analisadas("tuning", f, threshold, not_corr_features, features_missing_values, bool_missing_value, seed, counter)
